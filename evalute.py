...
def evalution(test_dataloader, model, max_n_objects=20, data_test_names=None):
    ...
    dir_in = "/Yx/majunze/fyj/GrscUnet/instance_2/"
    for batch in test_dataloader:
        ...
        ins_masks.save(dir_in + 'dress_PPRSUnet_' + str(cout) + '_ins_label.png')
        p_sem_pred.save(dir_in + 'dress_PPRSUnet_' + str(cout) + '_seg_label.png')
