...
def evalution(test_dataloader, model, max_n_objects=20, data_test_names=None):
    ...
    dir_in = "/tmp/pycharm_project_531/punet result/"
    for batch in test_dataloader:
        ...
        ins_masks.save(dir_in + 'dress_Punet_' + str(cout) + '_ins_label.png')
        p_sem_pred.save(dir_in + 'dress_Punet_' + str(cout) + '_seg_label.png')
        cout = cout + 1
